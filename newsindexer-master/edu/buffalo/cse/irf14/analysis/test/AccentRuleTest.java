	...
	public void testRule() {
		try {
			assertArrayEquals(new String[]{"The", "urban", "counterpart", "of", "chateau", "is", "palais"},
					runTest(TokenFilterType.ACCENT, "The urban counterpart of ch��teau is palais"));
			assertArrayEquals(new String[]{"The", "expression", "hotel", "particulier", "is", "used", "for", "an", "urban", "'private", "house'"}, 
					runTest(TokenFilterType.ACCENT, "The expression h��tel particulier is used for an urban 'private house'"));
			assertArrayEquals(new String[]{"Resumes", "can", "be", "used", "for", "a", "variety", "of", "reasons"}, 
					runTest(TokenFilterType.ACCENT, "R��sum��s can be used for a variety of reasons"));
			assertArrayEquals(new String[]{"for", "example", "vis-a-vis", "piece", "de", "resistance", "and", "creme", "brulee"}, 
					runTest(TokenFilterType.ACCENT, "for example vis-��-vis pi��ce de r��sistance and cr��me br��l��e"));
			assertArrayEquals(new String[]{"Spanish", "pinguino", "French", "aigue", "or", "aigue"}, 
					runTest(TokenFilterType.ACCENT, "Spanish ping��ino French aigu�� or aig��e"));
